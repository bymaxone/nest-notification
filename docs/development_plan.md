...
- **Overall progress:** 🔄 5 / 6 phases done (83%) — 43 / 49 tasks (88%)
...
| 6 | [Release v0.1.0](./tasks/phase-06-release.md) | 🔄 In Progress | 1/7 | MEDIUM | 2026-06-20 |
| | **Total** | 🔄 **5 / 6 phases** | **43 / 49 tasks** | — | — |
